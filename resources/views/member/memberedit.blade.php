                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="no_hp" value="{{ $no_hp }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="users_id" id="users_id" class="custom-select">
                                            ...
                                            <label>User</label>
                                            <select class="js-example-basic-single select2-hidden-accessible" style="width:100%" data-select2-id="1" tabindex="-1" aria-hidden="true" name="users_id">
                                                <option value="" selected disabled hidden>---Pilih---</option>
                                                @foreach ($users as $item)
                                                    <option value="{{ $item->id }}">{{ $item->username }}</option>
                                                @endforeach
