...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>AMRS</span></a></h1>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Penyedia Jasa Service Motor Dan Mobil<span>AMRS</span></h1>
            <h2></h2>
 ...
 <svg class="hero-waves" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 28 " preserveAspectRatio="none">
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              <h3>AMRS</h3>
              <p class="pb-3"><em>Sebuah bengkel yang ingin memanfaatkan teknologi</em></p>
              <p>
                A108 Agung <br>
                Tasikmalaya<br><br>
                <strong>Phone:</strong> +6287715568364<br>
                <strong>Email:</strong> agung@gmail.com<br>
              </p>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Tune Up</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Ganti Oli</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Sparepart</a></li>
            </ul>
          </div>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Agung</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
